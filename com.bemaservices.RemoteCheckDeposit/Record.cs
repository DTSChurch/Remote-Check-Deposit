...
namespace com.bemaservices.RemoteCheckDeposit
{
    ...
    public abstract class Record
    {
        ...
        public static Record DecodeRecord( BinaryReader reader )
        {
            ...
            {
                case 1:
                    record = new Records.X937.FileHeader();
                    break;

                case 10:
                    record = new Records.X937.CashLetterHeader();
                    break;

                case 20:
                    record = new Records.X937.BundleHeader();
                    break;

                case 25:
                    record = new Records.X937.CheckDetail();
                    break;

                case 26:
                    record = new Records.X937.CheckDetailAddendumA();
                    break;

                case 50:
                    record = new Records.X937.ImageViewDetail();
                    break;

                case 52:
                    record = new Records.X937.ImageViewData();
                    break;

                case 70:
                    record = new Records.X937.BundleControl();
                    break;

                case 90:
                    record = new Records.X937.CashLetterControl();
                    break;

                case 99:
                    record = new Records.X937.FileControl();
                    break;
