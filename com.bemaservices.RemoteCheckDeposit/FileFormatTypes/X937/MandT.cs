...
namespace com.bemaservices.RemoteCheckDeposit.FileFormatTypes
{
    ...
    /// DSTU standard.
    /// </summary>
    [Description( "Processes a batch export for M&T Bank." )]
    [Export( typeof( FileFormatTypeComponent ) )]
    [ExportMetadata( "ComponentName", "M&T Bank" )]
   
    public class MandT : X937DSTU
    {
        ...
        /// repeated. Ever.
        /// </summary>
        protected const string SystemSettingNextCashHeaderId = "MandT.NextCashHeaderId";

        /// <summary>
        /// The system setting that contains the last file modifier we used.
        /// </summary>
        protected const string SystemSettingLastFileModifier = "MandT.LastFileModifier";

        /// <summary>
        /// The last item sequence number used for items.
        /// </summary>
        protected const string LastItemSequenceNumberKey = "MandT.LastItemSequenceNumber";
        ...
        protected override FileHeader GetFileHeaderRecord( ExportOptions options )
        {
            ...
            header.ImmediateOriginRoutingNumber = header.ImmediateDestinationRoutingNumber; //same account for both (routing number)
        ...
        protected override CashLetterHeader GetCashLetterHeaderRecord( ExportOptions options )
        {
            ...
            //Instead of Contact Name, insert Account Number padded with zeros
            header.OriginatorContactName = Rock.Security.Encryption.DecryptString( GetAttributeValue( options.FileFormat, "AccountNumber" ) ).PadLeft(16, '0');
        ...
        protected override Records.X937.BundleHeader GetBundleHeader( ExportOptions options, int bundleIndex )
        {
            ...
            //Change return location routing number to Blank
