...
namespace com.bemaservices.RemoteCheckDeposit.FileFormatTypes
{
    ...
    /// DSTU standard.
    /// </summary>
    [Description( "Processes a batch export for Wheaton Bank." )]
    [Export( typeof( FileFormatTypeComponent ) )]
    [ExportMetadata( "ComponentName", "WheatonBank" )]
...
Amount: {{ Amount }}", order: 20 )]
    public class WheatonBank : X937DSTU
    {
        ...
        /// repeated. Ever.
        /// </summary>
        protected const string SystemSettingNextCashHeaderId = "WheatonBank.NextCashHeaderId";

        /// <summary>
        /// The system setting that contains the last file modifier we used.
        /// </summary>
        protected const string SystemSettingLastFileModifier = "WheatonBank.LastFileModifier";

        /// <summary>
        /// The last item sequence number used for items.
        /// </summary>
        protected const string LastItemSequenceNumberKey = "WheatonBank.LastItemSequenceNumber";
        ...
        protected override List<Record> GetBundleRecords( ExportOptions options, List<FinancialTransaction> transactions )
        {
            ...
            for ( int bundleIndex = 0; ( bundleIndex * MaxItemsPerBundle ) < transactions.Count(); bundleIndex++ )
            {
                ...
                //
                // provide credit detail records (type 25C).
                //
        ...
        {
            // change field 3 to institution routing number
            var institutionRoutingNumber = Rock.Security.Encryption.DecryptString( GetAttributeValue( options.FileFormat, "InstitutionRoutingNumber" ) );
            ...
            // change field 7 to a Bundle ID
            bundleHeader.ID = ( bundleIndex + 1 ).ToString( "0000000000" );

            // change field 10 to blanks
        ...
        protected override List<Record> GetCreditDetailRecords( ExportOptions options, int bundleIndex, List<FinancialTransaction> transactions )
        {
            ...
            var creditDetail = new CheckDetail //Type 25
            {
                ...
                OnUs = ( accountNumber + "/" + "120" ).PadLeft(18, '0').PadLeft(20, ' '),
        ...
        protected override List<Record> GetItemRecords( ExportOptions options, FinancialTransaction transaction )
        {
            ...
            //WheatonBank for each record where 25
            ...
            //Wheaton Bank: Remove all type 26
        ...
        protected override FileControl GetFileControlRecord( ExportOptions options, List<Record> records )
        {
            ...
            fileControl.ImmediateOriginContactName = string.Empty;
            fileControl.ImmediateOriginContactPhoneNumber = string.Empty;
