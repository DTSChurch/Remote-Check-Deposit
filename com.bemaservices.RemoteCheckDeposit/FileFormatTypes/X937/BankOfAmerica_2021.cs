...
namespace com.bemaservices.RemoteCheckDeposit.FileFormatTypes
{
    ...
    /// DSTU standard.
    /// </summary>
    [Description( "Processes a batch export for Bank of America." )]
    [Export( typeof( FileFormatTypeComponent ) )]
    [ExportMetadata( "ComponentName", "Bank of America" )]

    public class BankOfAmerica_2021 : X937DSTU
    {
        ...
        /// repeated. Ever.
        /// </summary>
        protected const string SystemSettingNextCashHeaderId = "BankOfAmerica.NextCashHeaderId";

        /// <summary>
        /// The system setting that contains the last file modifier we used.
        /// </summary>
        protected const string SystemSettingLastFileModifier = "BankOfAmerica.LastFileModifier";

        /// <summary>
        /// The last item sequence number used for items.
        /// </summary>
        protected const string LastItemSequenceNumberKey = "BankOfAmerica.LastItemSequenceNumber";
        ...
        protected override List<Record> GetItemRecords( ExportOptions options, FinancialTransaction transaction )
        {
            ...
            checkDetail.CheckDetailRecordAddendumCount = 0; // Added 11/1/2021

            //Modify Check Detail Adden A
            /* Excluded as BOA does not use Record 26 - on 10/25/21 by RTJ
