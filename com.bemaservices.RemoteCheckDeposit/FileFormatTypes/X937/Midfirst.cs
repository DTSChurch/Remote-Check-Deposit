...
{
    /// <summary>
    /// Defines the x937 File export for Midfirst Bank
    /// </summary>
    [Description( "Processes a batch export for Midfirst Bank." )]
    [Export( typeof( FileFormatTypeComponent ) )]
    [ExportMetadata( "ComponentName", "Midfirst Bank" )]
    ...
    public class MidfirstBank : X937DSTU
    {
        ...
        /// repeated. Ever.
        /// </summary>
        protected const string SystemSettingNextCashHeaderId = "MidfirstBank.NextCashHeaderId";

        /// <summary>
        /// The system setting that contains the last file modifier we used.
        /// </summary>
        protected const string SystemSettingLastFileModifier = "MidfirstBank.LastFileModifier";

        /// <summary>
        /// The last item sequence number used for items.
        /// </summary>
        protected const string LastItemSequenceNumberKey = "MidfirstBank.LastItemSequenceNumber";
