...
namespace com.bemaservices.RemoteCheckDeposit.FileFormatTypes
{
    ...
    /// </summary>
    [Description("Processes a batch export for Jack Henry & Associates, Inc.")]
    [Export(typeof(FileFormatTypeComponent))]
    [ExportMetadata("ComponentName", "Jack Henry & Associates")]
    ...
    public class JackHenry : X937DSTU
    {
        ...
        /// repeated. Ever.
        /// </summary>
        protected const string SystemSettingNextCashHeaderId = "JackHenry.NextCashHeaderId";

        /// <summary>
        /// The system setting that contains the last file modifier we used.
        /// </summary>
        protected const string SystemSettingLastFileModifier = "JackHenry.LastFileModifier";

        /// <summary>
        /// The last item sequence number used for items.
        /// </summary>
        protected const string LastItemSequenceNumberKey = "JackHenry.LastItemSequenceNumber";
        #endregion
        ...
        protected override List<Record> GetItemDetailRecords(ExportOptions options, FinancialTransaction transaction)
        {
            ...
            var transSubString = transactionRoutingNumber.Substring(0, 8);
            var transSubStringCheckDigit = transactionRoutingNumber.Substring(8, 1);
            ...
            var detail = new Records.X937.CheckDetail
            {
                ...
                PayorBankRoutingNumber = transSubString,
                PayorBankRoutingNumberCheckDigit = transSubStringCheckDigit,
                OnUs = string.Format("{0}/{1}", micr.GetAccountNumber(), micr.GetCheckNumber()).PadLeft(18, '0').PadLeft(20, ' '),
        ...
        protected override List<Record> GetCreditDetailRecords(ExportOptions options, int bundleIndex, List<FinancialTransaction> transactions)
        {
            ...
            //    OnUs = string.Format("{0}/", accountNumber).PadLeft(18, '0').PadLeft(20, ' '),
        ...
        protected override Records.X937.CashLetterControl GetCashLetterControlRecord(ExportOptions options, List<Record> records)
        {
            ...
            var control = new Records.X937.CashLetterControl
            {
                ...
                SettlementDate = controlRecord.SettlementDate
            };
