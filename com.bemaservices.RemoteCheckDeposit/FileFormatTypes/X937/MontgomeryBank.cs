...
namespace com.bemaservices.RemoteCheckDeposit.FileFormatTypes
{
    ...
    /// <summary>
    /// Defines the x937 File export for Montgomery Bank
    /// </summary>
    [Description("Processes a batch export for Montgomery Bank.")]
    [Export(typeof(FileFormatTypeComponent))]
    [ExportMetadata("ComponentName", "Montgomery Bank")]
    ...
    public class MontgomeryBank : X937DSTU
    {
        ...
        /// repeated. Ever.
        /// </summary>
        protected const string SystemSettingNextCashHeaderId = "Montgomery.NextCashHeaderId";

        /// <summary>
        /// The system setting that contains the last file modifier we used.
        /// </summary>
        protected const string SystemSettingLastFileModifier = "Montgomery.LastFileModifier";

        /// <summary>
        /// The last item sequence number used for items.
        /// </summary>
        protected const string LastItemSequenceNumberKey = "Montgomery.LastItemSequenceNumber";
        #endregion
