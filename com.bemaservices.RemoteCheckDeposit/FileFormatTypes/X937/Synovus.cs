...
namespace com.bemaservices.RemoteCheckDeposit.FileFormatTypes
{
    ...
    /// DSTU standard.
    /// </summary>
    [Description( "Processes a batch export for Synovus." )]
    [Export( typeof( FileFormatTypeComponent ) )]
    [ExportMetadata( "ComponentName", "Synovus" )]
...
Amount: {{ Amount }}"
    ...
    public class Synovus : X937DSTU
    {
        ...
        /// repeated. Ever.
        /// </summary>
        protected const string SystemSettingNextCashHeaderId = "Synovus.NextCashHeaderId";

        /// <summary>
        /// The system setting that contains the last file modifier we used.
        /// </summary>
        protected const string SystemSettingLastFileModifier = "Synovus.LastFileModifier";

        /// <summary>
        /// The last item sequence number used for items.
        /// </summary>
        protected const string LastItemSequenceNumberKey = "Synovus.LastItemSequenceNumber";
        ...
        protected override CashLetterControl GetCashLetterControlRecord( ExportOptions options, List<Record> records )
        {
            ...
            control.SettlementDate = null; //No Settlement for Synovus
            return control;
        }
        ...
        protected override List<Record> GetCreditDetailRecords( ExportOptions options, int bundleIndex, List<FinancialTransaction> transactions )
        {
            ...
            {
                PayorRoutingNumber = "061100606",
                CreditAccountNumber = accountNumber + "/754",
        ...
        protected override BundleControl GetBundleControl( ExportOptions options, List<Record> records )
        {
            ...
            control.MICRValidTotalAmount = 0; //blank for Synovus
            return control;
