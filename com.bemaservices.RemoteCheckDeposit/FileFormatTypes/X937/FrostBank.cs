...
namespace com.bemaservices.RemoteCheckDeposit.FileFormatTypes
{
    ...
    /// DSTU standard.
    /// </summary>
    [Description( "Processes a batch export for Frost Bank." )]
    [Export( typeof( FileFormatTypeComponent ) )]
    [ExportMetadata( "ComponentName", "Frost Bank" )]
   
    public class FrostBank : X937DSTU
    {
        ...
        /// repeated. Ever.
        /// </summary>
        protected const string SystemSettingNextCashHeaderId = "FrostBank.NextCashHeaderId";

        /// <summary>
        /// The system setting that contains the last file modifier we used.
        /// </summary>
        protected const string SystemSettingLastFileModifier = "FrostBank.LastFileModifier";

        /// <summary>
        /// The last item sequence number used for items.
        /// </summary>
        protected const string LastItemSequenceNumberKey = "FrostBank.LastItemSequenceNumber";
