...
Amount: {{ Amount }}", order: 30)]
    class BankOfAmericaMerrillLynch : X937DSTU
    {
        ...
        protected override Records.X937.FileHeader GetFileHeaderRecord(ExportOptions options)
        {
        ...
        /// 
        protected virtual Records.X937.CashLetterHeaderRecordType10 GetCashLetterHeaderRecord10(ExportOptions options)
        {
            ...
            var header = new Records.X937.CashLetterHeaderRecordType10
            {
                CollectionTypeIndicator = 12, // According to Veronica at BOA Merrill Lynch
                DestinationRoutingNumber = int.Parse(routingNumber),
                EceInstitutionRoutingNumber = int.Parse(accountNumber), // According to Veronica at BOA Marrill Lynch..
