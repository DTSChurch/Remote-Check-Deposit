...
IF NOT EXISTS (
    SELECT *
    FROM sys.objects
    WHERE object_id = OBJECT_ID(N'dbo._com_bemaservices_RemoteCheckDeposit_FileFormat')
    )
BEGIN

    CREATE TABLE [dbo].[_com_bemaservices_RemoteCheckDeposit_FileFormat] (
...
ALTER TABLE [dbo].[_com_bemaservices_RemoteCheckDeposit_FileFormat] DROP CONSTRAINT IF EXISTS [FK_com_bemaservices_RemoteCheckDeposit_FileFormat_CreatedByPersonAlias]
...
ALTER TABLE [dbo].[_com_bemaservices_RemoteCheckDeposit_FileFormat] DROP CONSTRAINT IF EXISTS [FK_com_bemaservices_RemoteCheckDeposit_FileFormat_EntityType]
ALTER TABLE [dbo].[_com_bemaservices_RemoteCheckDeposit_FileFormat]  WITH CHECK
...
ALTER TABLE [dbo].[_com_bemaservices_RemoteCheckDeposit_FileFormat] DROP CONSTRAINT IF EXISTS [FK_com_bemaservices_RemoteCheckDeposit_FileFormat_ModifiedByPersonAlias]
ALTER TABLE [dbo].[_com_bemaservices_RemoteCheckDeposit_FileFormat]  WITH CHECK
