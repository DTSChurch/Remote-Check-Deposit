                ...
                <div class="panel-body">
                    <div class="grid grid-panel">
                        ...
                        <Rock:GridFilter ID="gfBatches" runat="server" OnApplyFilterClick="gfBatches_ApplyFilterClick" OnClearFilterClick="gfBatches_ClearFilterClick" OnDisplayFilterValue="gfBatches_DisplayFilterValue">
                            ...
                            <Rock:DateRangePicker ID="drpExportDate" runat="server" Label="Export Date Range" />
                        </Rock:GridFilter>

                        <Rock:Grid ID="gBatches" runat="server" OnGridRebind="gBatches_GridRebind" OnRowDataBound="gBatches_RowDataBound">
                            <Columns>
                                <Rock:SelectField />
                                ...
                                <Rock:RockLiteralField ID="lTransactionCount" HeaderText="Transaction Count" SortExpression="TransactionCount" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" />
                                <Rock:RockLiteralField ID="lTransactionAmount" HeaderText="Batch Total" SortExpression="TransactionAmount" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" />
                                <Rock:RockLiteralField ID="lVariance" HeaderText="Variance" HeaderStyle-HorizontalAlign="Right" ItemStyle-HorizontalAlign="Right" />
                                <Rock:RockBoundField DataField="Campus.Name" HeaderText="Campus" SortExpression="CampusName" />
                                <Rock:RockLiteralField ID="lStatus" HeaderText="Status" SortExpression="Status" HeaderStyle-CssClass="grid-columnstatus" ItemStyle-CssClass="grid-columnstatus" FooterStyle-CssClass="grid-columnstatus" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" />
                                <Rock:RockLiteralField ID="lNotes" HeaderText="Note" />
                                <Rock:RockLiteralField ID="lDeposited" HeaderText="Deposited" SortExpression="Deposited" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                                <Rock:RockLiteralField ID="lExportDate" HeaderText="Export Date" SortExpression="ExportDate" />
                                <Rock:RockLiteralField ID="lExportFile" HeaderText="Export File" />
                            </Columns>
                        </Rock:Grid>
                    </div>
                </div>
                    ...
                    <asp:Repeater ID="rptMicrDetail" runat="server">
                        <ItemTemplate>
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <asp:HiddenField ID="hfIsBankCheck" runat="server" Value='<%#Eval("IsBankCheck")%>' />
            ...
            <div class="panel panel-block">
                ...
                <div class="panel-body">
                    ...
                    <dl>
                        ...
                        <dd>
                            <asp:Literal ID="lTotalDeposit" runat="server" /></dd>
                    </dl>
